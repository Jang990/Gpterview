...
public class AIService {
    ...
    public Message service(InterviewInfoDto interviewInfoDto, MessageHistory history) {
        // TODO: 여기서 List<Message>를 건드리면서 화면을 표시할 때 ROLE이 잘못되게 된다. 문제가 많다. DTO 분리를 잘 해줘야해...
        InterviewAIRequest request = interviewerStrategy.configStrategy(requester, interviewInfoDto, history); // 면접 전략 세팅.
