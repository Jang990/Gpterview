...
public interface InterviewerStrategy {
     ...
     * @param interviewInfoDto 진행되는 인터뷰 지원자의 정보
     * @param history 진행된 대화 기록
     * @return
     */
    InterviewAIRequest configStrategy(AISpecification aiSpec, InterviewInfoDto interviewInfoDto, MessageHistory history);
