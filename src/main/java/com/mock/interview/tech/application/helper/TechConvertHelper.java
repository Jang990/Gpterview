...
public class TechConvertHelper {
    ...
    public static List<TechViewDto> convertView(List<TechnicalSubjects> techList) {
        return techList.stream().map(TechConvertHelper::convertView).toList();
    }
    ...
    public static TechViewDto convertView(TechnicalSubjects tech) {
        return new TechViewDto(tech.getId(), tech.getName());
    }
